...
export class ControlledErrorThunk<T extends Options> extends Error {
    readonly message;
    readonly statusCode;
    readonly data;
    ...
    constructor(args: T) {
        ...
        Error.captureStackTrace(this, ControlledErrorThunk);
...
export type IControlledError = InstanceType<typeof ControlledErrorThunk>
